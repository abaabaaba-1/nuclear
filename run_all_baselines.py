...
Usage:
    ...
    # Run all coil baselines (GSCO-Lite)
...
# Coil baselines (coil design optimization; currently implemented as GSCO-Lite)
COIL_BASELINES = {
    ...
    "pymoo_nsga2": ["python", "baseline_gsco_pymoo.py", "nsga2", "problem/stellarator_coil_gsco_lite/config.yaml"],
    "pymoo_sms": ["python", "baseline_gsco_pymoo.py", "sms", "problem/stellarator_coil_gsco_lite/config.yaml"],
    "pymoo_moead": ["python", "baseline_gsco_pymoo.py", "moead", "problem/stellarator_coil_gsco_lite/config.yaml"],
    "pymoo_rvea": ["python", "baseline_gsco_pymoo.py", "rvea", "problem/stellarator_coil_gsco_lite/config.yaml"],
}
...
GSCO_LITE_BASELINES = {
    ...
    # Pymoo baselines implemented in baseline_gsco_pymoo.py
    "pymoo_nsga2": ["python", "baseline_gsco_pymoo.py", "nsga2", "problem/stellarator_coil_gsco_lite/config.yaml"],
    "pymoo_sms": ["python", "baseline_gsco_pymoo.py", "sms", "problem/stellarator_coil_gsco_lite/config.yaml"],
    "pymoo_moead": ["python", "baseline_gsco_pymoo.py", "moead", "problem/stellarator_coil_gsco_lite/config.yaml"],
    "pymoo_rvea": ["python", "baseline_gsco_pymoo.py", "rvea", "problem/stellarator_coil_gsco_lite/config.yaml"],
